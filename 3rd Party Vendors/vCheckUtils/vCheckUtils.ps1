...
.EXAMPLE
   ...
   Get-vCheckPlugin PluginName -proxy "http://0.0.0.0:3128"

.EXAMPLE
   Get plugin by name using proxy with auth (domain optional depending on your proxy auth)
   Get-vCheckPlugin PluginName -proxy "http://0.0.0.0:3128" -proxy_user "username" -proxy_pass "password -proxy_domain "domain"
...
<#
    ...
    .EXAMPLE
        Simple
		Get-vCheckVariablesSettings -PluginFile "C:\temp\vcheck6\vcenter\Plugins\20 Cluster\75 DRS Rules.ps1"
...
<#
	...
	.EXAMPLE
        Sync-vCheckDisabledPlugins -OldVcheckDir C:\temp\vcheck6\vccenter_old_20150218_163057 -NewVcheckDir C:\temp\vcheck6\vcenter
...
<#
	...
	.EXAMPLE
        Get-vCheckDisabledPlugins -VcheckDir C:\temp\vcheck6\vcenter
...
<#
    ...
    .EXAMPLE
        Upgrade-vCheckDirectory -CurrentvCheckPath C:\temp\vcheck6\vcenter -NewvCheckSource C:\temp\vcheck6\vcenter\vCheck-vSphere-master
	...
	This is my process for upgrading vCheck with this function.
	  1.  Extract a new, unmodified version of the vCheck to a directory.  For this example "C:\temp\vCheck\vCheck-vSphere-master".
	  2.  Load the utility - ". C:\temp\vCheck\vCheck-vSphere-master\vCheckUtils.ps1" .
	  3.  Upgrade-vCheckDirectory âCurrentvCheckPath C:\temp\vcheck\vcenterprod -NewvCheckSource C:\temp\vcheck6\vCheck-vSphere-master
	  4.  The list of plugin variable values is automatically opened in Notepad.
	  5.  Change directory to C:\temp\vcheck\vcenterprod .
