...
$Server = "srvvcenterp.example.com"
# End of Settings
...
$OpenConnection = $global:DefaulDomainServers | Where-Object { $_.Name -eq $VIServer }
...
#>
    ...
    [cmdletbinding()]
    param(
        [VMware.VimAutomation.ViCore.Types.V1.VIServer]$Server = $global:DefaulDomainServer,
