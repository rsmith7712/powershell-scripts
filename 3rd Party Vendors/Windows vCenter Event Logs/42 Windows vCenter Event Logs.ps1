...
$VCEventAge = Get-vCheckSetting $Title "VCEventAge" $VCEventAge
$VCEvntlgAge = Get-vCheckSetting $Title "VCEvntlgAge" $VCEvntlgAge
...
$Header = "Event Logs - Errors: [count]"
$Comments = ("The following errors were found in the vCenter Event Logs in the past {0} days, you may wish to check these further" -f $VCEvntlgAge)
