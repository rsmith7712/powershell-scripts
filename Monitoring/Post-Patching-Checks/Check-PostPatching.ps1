...
{
    0{$Script:ServerGroup = "00_servers"}
    1{$Script:ServerGroup = "01_servers"}
    2{$Script:ServerGroup = "02_servers"}
...
#TODO: Populate all computers in child wsus groups
#foreach ($wsusgroup in $wsus.GetComputerTargetGroups() | Where-Object {$_.Name -contains $Script:ServerGroup})
#{
#	$allcomputers = $wsusgroup.GetComputerTargets() | Select-Object -ExpandProperty FullDomainName
#}
#$allcomputerscount = $allcomputers.Count
#Write-Host "Total computers: $allcomputerscount"
