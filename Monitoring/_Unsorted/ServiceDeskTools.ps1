...
function Call-ServiceDeskTools_psf {
	...
	$usefulLinksToolStripMenuItem = New-Object 'System.Windows.Forms.ToolStripMenuItem'
	$dellWarrantyToolStripMenuItem = New-Object 'System.Windows.Forms.ToolStripMenuItem'
	$lenovoWarrantyToolStripMenuItem = New-Object 'System.Windows.Forms.ToolStripMenuItem'
	$brotherWarrantyToolStripMenuItem = New-Object 'System.Windows.Forms.ToolStripMenuItem'
	$preferredBrowserToolStripMenuItem = New-Object 'System.Windows.Forms.ToolStripMenuItem'
	$internetExplorerToolStripMenuItem = New-Object 'System.Windows.Forms.ToolStripMenuItem'
	$firefoxToolStripMenuItem = New-Object 'System.Windows.Forms.ToolStripMenuItem'
	$chromeToolStripMenuItem = New-Object 'System.Windows.Forms.ToolStripMenuItem'
	$InitialFormWindowState = New-Object 'System.Windows.Forms.FormWindowState'
	#endregion Generated Form Objects
	...
	$formServiceDeskTools_Load={
		...
		{
			$chromeToolStripMenuItem.Enabled = $false
		}
		if (!(Test-Path "C:\Program Files\Mozilla Firefox\firefox.exe"))
		{
			$firefoxToolStripMenuItem.Enabled = $false
		}
		...
		if ($browsercheck.browser -eq $null)
		{
			...
			$internetExplorerToolStripMenuItem.Checked=$true
		}
		...
		elseif ($browsercheck.browser -eq "firefox.exe")
		{
			...
			$firefoxToolStripMenuItem.Checked=$true
		}
		...
		{
			$aESTHETICToolStripMenuItem.Checked = $true
		}
	...
	$aboutToolStripMenuItem_Click={
		#TODO: Place custom script here
		[System.Windows.Forms.MessageBox]::Show("Service Desk Tools v1.4.2`nUpdated: 07/23/2018`n`nAuthor: user22`n","Service Desk Tools");
	}
	...
	$dellWarrantyToolStripMenuItem_Click={
		$computername = $Computer.Text
		$process = $script:preferredBrowser
	...
	$lenovoWarrantyToolStripMenuItem_Click={
		$computername = $Computer.Text
		$process = $script:preferredBrowser
	...
	$brotherWarrantyToolStripMenuItem_Click={
		$computername = $Computer.Text
		$process = $script:preferredBrowser
	...
	$lightToolStripMenuItem_Click={
		...
		Set-ItemProperty $themePath -Name "Theme" -Value "Light"
		Call-Information_Dialogue_psf "Please restart application to apply"
	}
	
	$darkToolStripMenuItem_Click={
		$themePath = "HKLM:\SOFTWARE\ServiceDeskTools"
		Set-ItemProperty $themePath -Name "Theme" -Value "Dark"
		Call-Information_Dialogue_psf "Please restart application to apply"
	}
	
	$aESTHETICToolStripMenuItem_Click={
		$themePath = "HKLM:\SOFTWARE\ServiceDeskTools"
		Set-ItemProperty $themePath -Name "Theme" -Value "Aesthetic"
		Call-Information_Dialogue_psf "Please restart application to apply"
	}
	...
	$internetExplorerToolStripMenuItem_Click={
		...
		$firefoxToolStripMenuItem.Checked = $false
	}
	
	$firefoxToolStripMenuItem_Click={
		Set-ItemProperty -Path "HKLM:\SOFTWARE\ServiceDeskTools" -Name "Browser" -Value "firefox.exe"
		$script:preferredBrowser = "firefox.exe"
		$internetExplorerToolStripMenuItem.Checked = $false
		$chromeToolStripMenuItem.Checked = $false
		$firefoxToolStripMenuItem.Checked = $true
	}
	
	$chromeToolStripMenuItem_Click={
	...
	$highContrastToolStripMenuItem_Click={
		$themePath = "HKLM:\SOFTWARE\ServiceDeskTools"
		Set-ItemProperty $themePath -Name "Theme" -Value "High Contrast"
		Call-Information_Dialogue_psf "Please restart application to apply"
	}
	...
	$Form_Cleanup_FormClosed=
	{
		...
		try
		{
			...
			$dellWarrantyToolStripMenuItem.remove_Click($dellWarrantyToolStripMenuItem_Click)
			$lenovoWarrantyToolStripMenuItem.remove_Click($lenovoWarrantyToolStripMenuItem_Click)
			$brotherWarrantyToolStripMenuItem.remove_Click($brotherWarrantyToolStripMenuItem_Click)
			$internetExplorerToolStripMenuItem.remove_Click($internetExplorerToolStripMenuItem_Click)
			$firefoxToolStripMenuItem.remove_Click($firefoxToolStripMenuItem_Click)
			$chromeToolStripMenuItem.remove_Click($chromeToolStripMenuItem_Click)
	...
	$formServiceDeskTools.Text = 'Service Desk Tools v1.4.2'
	...
	[void]$menustrip1.Items.Add($usefulLinksToolStripMenuItem)
	[void]$menustrip1.Items.Add($preferredBrowserToolStripMenuItem)
	...
	#
	[void]$usefulLinksToolStripMenuItem.DropDownItems.Add($dellWarrantyToolStripMenuItem)
	[void]$usefulLinksToolStripMenuItem.DropDownItems.Add($lenovoWarrantyToolStripMenuItem)
	[void]$usefulLinksToolStripMenuItem.DropDownItems.Add($brotherWarrantyToolStripMenuItem)
	$usefulLinksToolStripMenuItem.Name = 'usefulLinksToolStripMenuItem'
	$usefulLinksToolStripMenuItem.Size = '82, 20'
	$usefulLinksToolStripMenuItem.Text = 'Useful Links'
	#
	# dellWarrantyToolStripMenuItem
	#
	$dellWarrantyToolStripMenuItem.Name = 'dellWarrantyToolStripMenuItem'
	$dellWarrantyToolStripMenuItem.Size = '164, 22'
	$dellWarrantyToolStripMenuItem.Text = 'Dell Warranty'
	$dellWarrantyToolStripMenuItem.add_Click($dellWarrantyToolStripMenuItem_Click)
	#
	# lenovoWarrantyToolStripMenuItem
	#
	$lenovoWarrantyToolStripMenuItem.Name = 'lenovoWarrantyToolStripMenuItem'
	$lenovoWarrantyToolStripMenuItem.Size = '164, 22'
	$lenovoWarrantyToolStripMenuItem.Text = 'Lenovo Warranty'
	$lenovoWarrantyToolStripMenuItem.add_Click($lenovoWarrantyToolStripMenuItem_Click)
	#
	# brotherWarrantyToolStripMenuItem
	#
	$brotherWarrantyToolStripMenuItem.Name = 'brotherWarrantyToolStripMenuItem'
	$brotherWarrantyToolStripMenuItem.Size = '164, 22'
	$brotherWarrantyToolStripMenuItem.Text = 'Brother Warranty'
	$brotherWarrantyToolStripMenuItem.add_Click($brotherWarrantyToolStripMenuItem_Click)
	#
	# preferredBrowserToolStripMenuItem
	#
	[void]$preferredBrowserToolStripMenuItem.DropDownItems.Add($internetExplorerToolStripMenuItem)
	[void]$preferredBrowserToolStripMenuItem.DropDownItems.Add($firefoxToolStripMenuItem)
	[void]$preferredBrowserToolStripMenuItem.DropDownItems.Add($chromeToolStripMenuItem)
	$preferredBrowserToolStripMenuItem.Name = 'preferredBrowserToolStripMenuItem'
	$preferredBrowserToolStripMenuItem.Size = '112, 20'
	$preferredBrowserToolStripMenuItem.Text = 'Preferred Browser'
	#
	# internetExplorerToolStripMenuItem
	#
	$internetExplorerToolStripMenuItem.Name = 'internetExplorerToolStripMenuItem'
	$internetExplorerToolStripMenuItem.Size = '160, 22'
	$internetExplorerToolStripMenuItem.Text = 'Internet Explorer'
	$internetExplorerToolStripMenuItem.add_Click($internetExplorerToolStripMenuItem_Click)
	#
	# firefoxToolStripMenuItem
	#
	$firefoxToolStripMenuItem.Name = 'firefoxToolStripMenuItem'
	$firefoxToolStripMenuItem.Size = '160, 22'
	$firefoxToolStripMenuItem.Text = 'Firefox'
	$firefoxToolStripMenuItem.add_Click($firefoxToolStripMenuItem_Click)
	#
	# chromeToolStripMenuItem
	#
	$chromeToolStripMenuItem.Name = 'chromeToolStripMenuItem'
	$chromeToolStripMenuItem.Size = '160, 22'
	$chromeToolStripMenuItem.Text = 'Chrome'
	$chromeToolStripMenuItem.add_Click($chromeToolStripMenuItem_Click)
