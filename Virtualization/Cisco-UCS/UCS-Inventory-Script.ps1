...
if(!(Get-Module -ListAvailable -Name Cisco.UCSManager))
{
	...
	if(!(Get-Module -ListAvailable -Name CiscoUcsPS))
	{
		...
		Write-Host "Cisco UCS PowerTool v1 loaded" -ForegroundColor "yellow"
	}
}
else {
	# Load PowerTool 2.x
	Import-Module Cisco.UCSManager
	Write-Host "Cisco UCS PowerTool v2 loaded" -ForegroundColor "yellow"
}
...
function GenerateReport()
{
	...
	AddToOutput -txt ".ui-tabs-vertical .ui-tabs-panel { float: left; width: site; }"
