...
Connect-VIserver "domainvc1"

New-VMFromSnapshot -SourceVM "QS0-FSC-APP1" -CloneName "DS0-FSC-APP1-ENG" -SnapshotName "Post SQL Install, Pre StoreCenter" -Cluster "DS0-VSP-CL1" -Datastore "NIM1-DEV-WTIER1-VOL01" -VMFolder "DEV_CORP"