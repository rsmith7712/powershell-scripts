...
$applianceSubscriptionId = 'db8cba0d-68a9-4c06-a089-b14205b99d53'
$applianceResourceGroupName = 'rg-Azure-ARC-to-vCenter'
$applianceName = 'rb-Azure-ARC-to-vCenter'

$customLocationSubscriptionId = 'db8cba0d-68a9-4c06-a089-b14205b99d53'
$customLocationResourceGroupName = 'rg-Azure-ARC-to-vCenter'
$customLocationName = 'Azure-ARC-to-vCenter'

$vCenterSubscriptionId = 'db8cba0d-68a9-4c06-a089-b14205b99d53'
$vCenterResourceGroupName = 'rg-Azure-ARC-to-vCenter'
$vCenterName = 'HQ-vCenter'
...
function fetchVcenterDetailsInto($vcenterDetails) {
    ...
    while ($true) {
        ...
        "`t* If your vCenter URL is http://0.0.0.0:9090/ then enter 0.0.0.0:9090`n" +
...
if ($UseProxy) {
    ...
    while ($true) {
        $proxyURL = Read-Host "Please enter Proxy URL (ex: http://0.0.0.0:3128 or http://proxy.contoso.com:8080)"
