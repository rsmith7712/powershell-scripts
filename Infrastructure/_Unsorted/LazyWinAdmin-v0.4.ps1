...
#----------------------------------------------
[void][Reflection.Assembly]::Load("System, Version=0.0.0.0, Culture=neutral, PublicKeyToken=b77a5c561934e089")
...
[void][Reflection.Assembly]::Load("mscorlib, Version=0.0.0.0, Culture=neutral, PublicKeyToken=b77a5c561934e089")
	...
	Process {
	    ...
	    ForEach ($c in $computer) {
	        ...
	        If (Test-Connection -ComputerName $c -Quiet -Count 1) {
	            ...
	            If (Test-Path "\\$c\C$\...\hosts") {
	                Switch -regex -file ("\\$c\c$\...\hosts") {
	                    "^\d\w+" {
...
function Call-MainForm_pff
{
	...
	$button_UseOrgroupLocalUsers = New-Object 'System.Windows.Forms.Button'
	$button_UseOrgroupLocalGroups = New-Object 'System.Windows.Forms.Button'
	...
	$button_mmcCompmgmt_Click={
		...
		if (($ComputerName -like "localhost") -or ($ComputerName -like ".") -or ($ComputerName -like "0.0.0.0") -or ($ComputerName -like "$env:computername")) {
	...
	$button_UseOrgroupLocalUsers_Click={
		Get-ComputerTxtBox
	...
	$button_UseOrgroupLocalGroups_Click={
		$button_UseOrgroupLocalGroups.Enabled = $false
		Get-ComputerTxtBox
		$result = Get-WmiObject -Class Win32_Group -ComputerName $ComputerName	| Where-Object {$_.LocalAccount}|ft -auto|Out-String
		Add-RichTextBox $result
		$button_UseOrgroupLocalGroups.Enabled = $true
	}
	...
	$button_HostsFile_Click={
		...
		if (($ComputerName -eq "localhost") -or ($ComputerName -eq "0.0.0.0") -or ($ComputerName -eq "$env:ComputerName") -or ($ComputerName -eq $IP)) {
			$resultHostFile = Get-HostsFile | Out-String
	...
	$buttonWindowsUpdateLog_Click={
		...
		$pathToWindowsUpdateLog= "\\$computername\$SystemDriveLetter$\...\WindowsUpdate.log"
	...
	$buttonReportingEventslog_Click={
		...
		$SystemDriveLetter = ((Get-WmiObject -Class Win32_OperatingSystem -ComputerName $ComputerName).systemdrive).substring(0,1)
		$SystemDriveFolder = ((Get-WmiObject -Class Win32_OperatingSystem -ComputerName $ComputerName).WindowsDirectory).substring(3)
		$pathToWSUSReportLog= "\\$computername\$SystemDriveLetter$\...\ReportingEvents.log"
	...
	$Form_Cleanup_FormClosed=
	{
		...
		try
		{
			...
			$button_UseOrgroupLocalUsers.remove_Click($button_UseOrgroupLocalUsers_Click)
			$button_UseOrgroupLocalGroups.remove_Click($button_UseOrgroupLocalGroups_Click)
...
ghDKRn7vzKIIOrgCxr/9Acm0BiJprYQRiSAiH9BApCnaPkT6pngCHhRpd4qyG5F2JbKuVWNwqRwh
...
Za5iPnB5i8GRfTF05FwBQXsOrg4f0CylMW57lHY5Q64ho9yfs8o29Blh5HdN1XEpZ6daHp+NAkrO
...
yOl5co93qgAAAABJRU5ErkJggg==')
	...
	#
	$groupbox_UsersAndGroups.Controls.Add($button_UseOrgroupLocalUsers)
	$groupbox_UsersAndGroups.Controls.Add($button_UseOrgroupLocalGroups)
	...
	#
	# button_UseOrgroupLocalUsers
	#
	$button_UseOrgroupLocalUsers.Location = '14, 21'
	$button_UseOrgroupLocalUsers.Name = "button_UseOrgroupLocalUsers"
	$button_UseOrgroupLocalUsers.Size = '94, 23'
	$button_UseOrgroupLocalUsers.TabIndex = 17
	$button_UseOrgroupLocalUsers.Text = "Local Users"
	$button_UseOrgroupLocalUsers.UseVisualStyleBackColor = $True
	$button_UseOrgroupLocalUsers.add_Click($button_UseOrgroupLocalUsers_Click)
	#
	# button_UseOrgroupLocalGroups
	#
	$button_UseOrgroupLocalGroups.Location = '14, 50'
	$button_UseOrgroupLocalGroups.Name = "button_UseOrgroupLocalGroups"
	$button_UseOrgroupLocalGroups.Size = '94, 23'
	$button_UseOrgroupLocalGroups.TabIndex = 18
	$button_UseOrgroupLocalGroups.Text = "Local Groups"
	$button_UseOrgroupLocalGroups.UseVisualStyleBackColor = $True
	$button_UseOrgroupLocalGroups.add_Click($button_UseOrgroupLocalGroups_Click)
	#
	# groupbox_software
	#
...
8Rezp0WPEQCT19VI9ht4+/f91s/7C15/gw03Rua3/v9AevJ3IyD0pWIoDomainLvP5GQP4LJcDn3i9q
...
mV3YHXObqDtlLCPuldkbfLvcTv/c8jDomaingA3cyttuplTZaNv7gebfHOqY/NrYOdrYuFrE6k/xc5/
...
dgUW8k+l4Cfk1yP/Atb7i5CfZwOcuvcDa/Domain37xIuCbBMCU/CZkLyHvz/7u3zyL4DtlYdRTI/ln
...
fV0ADFV/7P9WQ/QX8jcyJT+FP8ODomainYUQKy/av/1gl/xyK8SX4Oe62uWXye/UQCKWP6iAtBybbiy
...
EHbd4N+J7YEMlN2yWT8hCNtrwM19rMTxAnQxpL2S99DomainvEB/I6bSPwbSuabUj8cr6+AT5Y/TJJ8
...
6jMuser9A2NMjFkpTcy4A8n5RBDKMZ8q2I5BUA1YEsowvBWDVQDZdlwKwagBtllbhN7quoFGOgKQw
