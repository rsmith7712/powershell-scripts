...
try {
    ...
    $env:SUBSCRIPTION_ID = "db8cba0d-68a9-4c06-a089-b14205b99d53";
    $env:RESOURCE_GROUP = "rg-Azure-ARC-to-vCenter";
    $env:TENANT_ID = "c14f00fd-6be3-4f9c-b061-c72c360b1ddd";
    $env:LOCATION = "westus2";
    $env:AUTH_TYPE = "token";
    $env:CORRELATION_ID = "0b731a69-dfdd-457b-a291-f43f283939a4";
