...
$Script:Logfile = "C:\temp\ManagerLicense_$stamp.txt"
...
$fullusers = Get-ADUser -Filter * -SearchBase "ou=store managers,ou=store accounts,dc=domain,dc=com"
