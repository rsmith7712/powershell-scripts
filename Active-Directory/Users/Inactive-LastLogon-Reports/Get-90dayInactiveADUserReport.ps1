# Get-90dayInactiveADUserReport_v3.ps1
#
...
export-csv c:\Get-90dayInactiveADUserReport_v3_USERS.csv
...
} | Select UserName,Groups | Export-Csv C:\Get-90dayInactiveADUserReport_v3_GROUPS.csv -NTI
