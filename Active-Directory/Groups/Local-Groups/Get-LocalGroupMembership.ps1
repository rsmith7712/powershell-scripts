...
<#
    ...
    .EXAMPLE
       ...
       import-csv c:\TestServers.csv | Get-LocalGroupMembership | Where Name | Export-CSV c:\LocalAdmins.csv

       Get-Content "c:\TestServers.txt" | Get-LocalGroupMembership | Where Name | Export-CSV c:\LocalAdmins.csv
